...
class UpdateMouseFragment : Fragment() {
    ...
    private var code: Int? = args.mouse.code
    ...
    private fun initMouse(){
        binding.cbGravit.isChecked = args.mouse.gravitidy == 1
    ...
    private fun updateMouse() {
        ...
        if (checkInput(code!!, speciesID, trapID)){
            val mouse = Mouse(args.mouse.mouseId, code, speciesID, protocolID, args.mouse.occasionID,
