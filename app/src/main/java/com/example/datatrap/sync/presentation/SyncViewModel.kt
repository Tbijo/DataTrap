...
import com.example.datatrap.sync.data.remote.ImageSync
import com.example.datatrap.sync.data.remote.LocOccLMouse
import com.example.datatrap.sync.data.remote.LocalitySync
import com.example.datatrap.sync.data.remote.MouseImageSync
import com.example.datatrap.sync.data.remote.MouseSync
import com.example.datatrap.sync.data.remote.OccasionImageSync
import com.example.datatrap.sync.data.remote.OccasionSync
import com.example.datatrap.sync.data.remote.ProjectSync
import com.example.datatrap.sync.data.remote.SesLOLM
import com.example.datatrap.sync.data.remote.SessionSync
import com.example.datatrap.sync.data.remote.SpecieImageSync
import com.example.datatrap.sync.data.remote.SyncClass
